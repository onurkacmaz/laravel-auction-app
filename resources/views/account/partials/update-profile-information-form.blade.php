<section>
    ...
    <form method="post" action="{{ route('profile.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input disabled="{{!empty($user->tc_identification_number)}}" id="tc_identification_number" name="tc_identification_number" type="text" class="mt-1 block w-full disabled:opacity-50" :value="old('tc_identification_number', $user->tc_identification_number)" autofocus autocomplete="name" />
