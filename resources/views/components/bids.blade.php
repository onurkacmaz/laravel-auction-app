...
@if($bids->count() > 0)
    ...
    @foreach($bids as $bid)
        ...
        @endphp
        <div
            class="other-text flex border-b odd:border-b-none py-3 odd:bg-gray-200 even:bg-gray-100 px-4 flex-row justify-between">
            @if($hideName)
...
@else
    <div class="bg-gray-100 p-4 rounded-lg text-center mt-4">
        <b class="text-gray-400">Henüz teklif yok.</b>
    </div>
@endif
<div class="my-4">
    {!! $bids->links() !!}
