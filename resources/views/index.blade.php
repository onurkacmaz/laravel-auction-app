                                                            ...
                                                            <div class="p-4 text-white bottom-0 absolute right-0 left-0 !bg-[#333]/70 text-center">
                                                                <div class="flex justify-center">
                                                                    <input id="bid_amount" type="number"
                                                                           name="bid_amount" placeholder="Örn. {{ Str::currency($artWork->minimum_bid + $artWork->limit_value) }}"
                                                                ...
                                                                <div class="product-social">
                                                                    <div class="product-social-content product-social-content-{{$artWork->id}}  openbox-content">
                                                                        <div>
                                                                            <div>
                                                                                <a target="_blank"
                                                                ...
                                                                <div class="flex justify-center mt-4 grid bg-gray-100 text-dark grid-cols-4 divide-x border rounded-lg">
                                                                    <a  href="#" data-is-favorite="{{(int)!is_null($artWork->favorite())}}" data-id="{{$artWork->id}}"
                                                                    ...
                                                                    <a href="#" data-is-follow="{{(int)!is_null($artWork->followed())}}" data-id="{{$artWork->id}}"
                                                                    ...
                                                                    <a data-target="product-social-content-{{$artWork->id}}" href="javascript:void(0);" class="share p-3 font-bold hover:bg-gray-200 text-[1rem] flex flex-column openbox product-social-icon">
