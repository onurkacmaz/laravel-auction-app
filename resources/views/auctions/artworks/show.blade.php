@php use App\Models\BidLog;use Illuminate\Support\Facades\Vite;use Illuminate\Support\Str; @endphp
@extends('base')
@section('meta')
                        ...
                        <div class="col-lg-6">
                            <div class="product-left position-relative">
                                ...
                                <div id="product-thumb-image" class="grid grid-cols-4 lg:grid-cols-6 gap-4 !h-auto">
                                    @foreach($artWork->images as $key => $image)
                                        <a href="{{$key}}" class="opacity-70 hover:opacity-100 transition-all ease-in-out delay-15">
                                    ...
                                    @if(is_null($artWork->userArtWork))
                                        <div id="product-user-buttons">
                                            ...
                                            <div class="product-social">
                                                <a href="javascript:void(0);"
                                                   data-target="product-social-content" class="openbox product-social-icon">
...
@section('js')
    ...
    <script type="text/javascript" src="//st1.myideasoft.com/idea/lc/38/themes/selftpl_63a0c6bbd7a25/assets/javascript/product.js?revision=7.2.4.7-10-1674143460"></script>
