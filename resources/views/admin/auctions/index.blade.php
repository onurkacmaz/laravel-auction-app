...
<x-admin-layout>
            ...
            <div class="overflow-hidden p-4 sm:p-8 bg-white shadow sm:rounded-lg">
                <table class="w-full">
                    ...
                    <tr>
                        ...
                        <th class="hidden lg:block text-sm text-left p-4 bg-indigo-50">Bitişe Kalan Süre</th>
                    ...
                    @foreach($auctions as $auction)
                        <tr class="border-b">
                            ...
                            <td class="text-sm text-left font-bold p-4 hidden lg:block ">
  ...
  <svg aria-hidden="true" class="w-3 h-3 mr-1 hidden lg:block" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg"><path fill-rule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm1-12a1 1 0 10-2 0v4a1 1 0 00.293.707l2.828 2.829a1 1 0 101.415-1.415L11 9.586V6z" clip-rule="evenodd"></path></svg>
